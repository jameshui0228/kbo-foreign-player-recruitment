...
| 3 | Candidate market construction | Naver candidate news attached | 93% | `outputs/tables/ssg_market_realism_news_join_v0_4.csv` | fill salary, opt-out, transfer-fee, buyout, agent, medical, and Korea-willingness source lanes |
...
| 5 | Failure risk model | Naver news risk signals attached | 84% | `outputs/tables/candidate_news_signal_summary_v0_4.csv` | fill medical/adaptation/Korea-willingness source lanes |
| 6 | SSG fit ranking | locked Naver-enriched feasibility queue built | 70% | `docs/run_029_naver_candidate_news_v0_4.md` | fill feasibility source lanes before any shortlist/recommendation labels |
