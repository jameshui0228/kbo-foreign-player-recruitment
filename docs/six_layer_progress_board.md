...
| 6 | SSG fit ranking | locked scouting-card templates built | 85% | `outputs/tables/locked_scouting_card_templates_v0_1.csv` | fill manual scouting notes, contract values, medical status, and Korea-willingness evidence before any candidate names, ranks, shortlist labels, or recommendations are released |
