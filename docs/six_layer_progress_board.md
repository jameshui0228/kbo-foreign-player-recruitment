...
| 3 | Candidate market construction | expanded English candidate news attached | 91% | `outputs/tables/ssg_market_realism_news_join_v0_2.csv` | load Naver credentials for Korean candidate news and add salary, opt-out, transfer-fee, buyout, agent, and Korea-willingness sources |
...
| 5 | Failure risk model | expanded English news risk attached | 81% | `outputs/tables/candidate_news_signal_summary_v0_2.csv` | run Korean/Naver candidate news and add full medical/adaptation/Korea-willingness checks |
| 6 | SSG fit ranking | locked expanded news-enriched work queue built | 66% | `docs/run_026_candidate_news_expansion_v0_2.md` | load Korean/Naver news and salary/contract verification before any shortlist/recommendation labels |
