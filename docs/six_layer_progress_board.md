...
| 3 | Candidate market construction | partial plus with MiLB context | 68% | `outputs/tables/mlb_market_pool_milb_role_context_v1.csv` | add ABL roster, contract/salary/opt-out signals, news/manual availability checks, and market-watch MiLB coverage |
